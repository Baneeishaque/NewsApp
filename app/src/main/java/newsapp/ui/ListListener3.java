...
public class ListListener3 implements OnItemClickListener {
	...
	public ListListener3(List<RssItem> aListItems, Activity anActivity) {
	...
	public void onItemClick(AdapterView<?> parent, View view, int pos, long id) {
		...
		Intent t=new Intent(view.getContext(),Lang4.class);
