...
public class Lang5 extends ActionBarActivity {
	Vector ls;
	private WebView v;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_lang22);
		String title="";
		String content="";
		String category="";
		...
		title=ListListener4.b;
		//title="ിിേീ";
		content=ListListener4.c;
